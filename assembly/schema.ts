...
/**
 * Standard error codes used in MCP
 */
...
export function validateRequest(request: JSONRPCRequest): boolean {
  return (
    request.jsonrpc === "2.0" &&
...
export function validateNotification(notification: JSONRPCNotification): boolean {
  return (
...
export function validateResult(result: Result): boolean {
  return typeof result === "object" && result !== null;
}

export function validateCompletionResult(result: unknown): boolean {
  if (typeof result !== "object" || result === null) {
    return false;
  }
  const completion = result as CompletionResult;
  return typeof completion.text === "string" && typeof completion.isComplete === "boolean";
}
...
export function validatePromptResult(result: unknown): boolean {
  if (typeof result !== "object" || result === null) {
    return false;
  }
  const prompt = result as PromptResult;
  return typeof prompt.name === "string" && typeof prompt.content === "string" &&
...
export function validateResourceListResult(result: unknown): boolean {
  if (typeof result !== "object" || result === null) {
    return false;
  }
  const list = result as ResourceListResult;
